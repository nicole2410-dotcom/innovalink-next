...
export default function CompareDrawer() {
  ...
  return (
    <>
      <button onClick={() => setOpen(!open)} className="fixed bottom-6 right-6 z-50 px-4 py-2.5 rounded-full bg-gradient-to-r from-vino to-vino-light text-white font-medium shadow-2xl hover:from-vino-light hover:to-vino transition-all duration-300 flex items-center gap-2">
